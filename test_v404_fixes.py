...
check("APP_VERSION >= v4.0.4", APP_VERSION in ("v4.0.4", "v4.0.5", "v4.1.0"), got=APP_VERSION)
check("BUILD_STAGE updated",   "Browser" in BUILD_STAGE or "Mobile" in BUILD_STAGE or "Data Foundation" in BUILD_STAGE, got=BUILD_STAGE)
