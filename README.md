...
## 香港股票智能分析系統 — v0.6.6 Landing + Report Summary Cleanup Layer
...
This is **v0.6.6 Landing + Report Summary Cleanup Layer** of the Buildway Tech HK stock intelligence platform. It uses a multi-agent architecture to analyze Hong Kong-listed stocks and generate professional PDF risk reports in Traditional Chinese.

**Current Version:** v0.6.6 — Landing + Report Summary Cleanup Layer
**Previous Phase:** v0.6.5 — Report Page Layout Cleanup Layer
...
- [ ] **4. Verify version** — App must show `v0.6.6 — Landing + Report Summary Cleanup Layer` and today's date
...
### PDF Chinese font priority (v0.6.6)
...
| Version | Date | Notes |
|---------|------|-------|
| v0.6.6 | 2026-05-28 | Landing + Report Summary Cleanup Layer — simplified hero, removed quick test cards, added company logo summary |
| v0.6.5 | 2026-05-28 | Report Page Layout Cleanup Layer — PDF download moved higher, duplicate preview/company sections removed |
